/**
 * Single Port Memory UVM Driver
 * Drives transactions to DUT
 */

class single_port_mem_driver_uvm extends uvm_driver #(single_port_mem_transaction);
    `uvm_component_utils(single_port_mem_driver_uvm)
