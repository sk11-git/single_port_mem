/**
 * Single Port Memory UVM Scoreboard
 * Verifies correctness of memory operations
 */

class single_port_mem_scoreboard_uvm extends uvm_scoreboard;
    `uvm_component_utils(single_port_mem_scoreboard_uvm)
    
    uvm_analysis_imp #(single_port_mem_transaction, single_port_mem_scoreboard_uvm) analysis_export;
